      ...
      <template>
        ...
        >
          ...
          <!-- <drag-selector-item :value="control"> -->
            ...
            <UseSpinButton v-if="control.type==='SpinButton'" :control="control" :modal="modal" />
            <UseTabStrip v-if="control.type==='TabStrip'" :control="control" :modal="modal" />
            <UseMultiPage v-if="control.type==='MultiPage'" :control="control" :modal="modal" />
