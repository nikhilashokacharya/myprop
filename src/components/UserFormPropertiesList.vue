<template>
  <div>
    ...
    <div class="form-group">
      ...
      <SpinButtonControlTable v-if="selectedOption.type==='SpinButton'" :selectedUserForm="selectedOption" />
      <!--  -->
...
<TabStripTable v-if="selectedOption.type==='TabStrip'" :selectedUserForm="selectedOption" />
<MultiPageTable v-if="selectedOption.type==='MultiPage'" :selectedUserForm="selectedOption" />
<!-- <PageTable v-if="selectedOption.type==='MultiPage'" :selectedUserForm="selectedOption" /> -->
...
import SpinButtonControlTable from './SpinButtonControlTable.vue';
import TabStripTable from './TabStripTable.vue';
...
@Component({
  components: { UserFormTable, LabelControlTable, CommandButtonControl,CustomTextBoxTable,CustomCheckBoxTable,ComboBoxTable, SpinButtonControlTable, TabStripTable, MultiPageTable, PageTable }
})
