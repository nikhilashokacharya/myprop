  ...
  <div>
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td>
          <select
            :value="getSelectedControl.dropButtonStyle"
            @change="handleChangeInput($event,'dropButtonStyle')"
          >
      ...
      <tr>
        <td>ListStyle</td>
        <td>
          <select :value="getSelectedControl.listStyle" @change="handleChangeInput($event,'listStyle')">
...
import listStyle from "../models/listStyle.json"
