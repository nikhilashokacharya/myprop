    ...
    <table class="table">
      ...
      <tr>
        ...
        <td>
          <input
            type="number"
            :value="getSelectedControl.style.delay  | sizeFilter"
            @change="handleSizeForControls($event,getSelectedControl,'delay')"
            @keyup.enter="handleSizeForControls($event,getSelectedControl,'delay')"
          />
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
           <input
            type="number"
            v-model="getSelectedControl.max"
             @change="handleChangeInputNumber($event,'max')"
          >
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input
            type="number"
            v-model="getSelectedControl.min"
             @change="handleChangeInputNumber($event,'min')"
          >
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Orientation</td>
        <td>
          <select :value="getSelectedControl.orientation" @change="handleChangeInput($event,'orientation')">
            <option v-for="(value,key) in orientation" v-bind:value="value" :key="key">{{key}}</option>
          </select>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input
            type="number"
            v-model="getSelectedControl.smallChange"
             @change="handleChangeInputNumber($event,'smallChange')"
          >
        </td>
      </tr>
      <tr>
